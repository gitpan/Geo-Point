...
COMPONENTS are L<Math::Polygon|Math::Polygon>, L<Math::Polygon::Surface|Math::Polygon::Surface>, L<Geo::Line|Geo::Line>,
and L<Geo::Surface|Geo::Surface> objects.  When an ARRAY is specfied as COMPONENT,
it will be used to instantiate a L<Math::Polygon::Surface|Math::Polygon::Surface> object.
In case of a L<Geo::Surface|Geo::Surface>, the included polygons are translated to
...
This module is part of Geo-Point distribution version 0.90,
built on January 27, 2009. Website: F<http://perl.overmeer.net/geo/>
