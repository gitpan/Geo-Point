...
The NICK must be defined with L<new()|Geo::Proj/"Constructors">.  Returned is the nickname for
...
This module is part of Geo-Point distribution version 0.09,
built on January 02, 2009. Website: F<http://perl.overmeer.net/geo/>
